/* =============================================================
   Mango · utils/dom.js — tiny DOM helpers + SVG icon set
   ============================================================= */
...
App.dom = (function () {
  ...
  function on(root, event, selectorOrHandler, maybeHandler) {
    ...
    root.addEventListener(event, (e) => {
      ...
      if (t && root.contains(t)) maybeHandler(e, t);
    });
  }
  ...
  /* ---- Inline icon set (Lucide-style, 24x24, currentColor) ---- */
  const PATHS = {
    ...
    users: '<circle cx="9" cy="8" r="3.5"/><path d="M2 21v-1a5 5 0 0 1 5-5h4a5 5 0 0 1 5 5v1"/><path d="M16 4.5a3.5 3.5 0 0 1 0 7M22 21v-1a5 5 0 0 0-3.5-4.8"/>',
  ...
  function mount(container, html) { container.innerHTML = html; return container; }

  return { $, $$, on, esc, icon, mount };
})();
